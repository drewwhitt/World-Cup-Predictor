...
function Content() {
  return (
    <>
      ...
      <p className="dek">
        A projected Quarterfinal between two of the tournament's strongest sides — and the
        reasoning behind the model's current 57–43 split.
      </p>
      <p className="meta-line">Updated July 3, 2026</p>

      <p>
        As the bracket takes shape, France and Spain are on course for a Quarterfinal meeting
...
export const page: InsightPage = {
  ...
  description:
    "Veridex's model gives France a 57% chance over Spain in a projected World Cup Quarterfinal. Here's the reasoning behind the number.",
