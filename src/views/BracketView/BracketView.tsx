...
const R32_MATCHUPS: Array<{ id: string; home: TeamCode; away: TeamCode }> = [
  ...
  // relationships, not assumed. ko-93 (R16) is fed by ko-83/ko-84, and
  // ko-94 by ko-81/ko-82 — the reverse of naive sequential order — while
  // ko-95/ko-96 correctly use adjacent pairs (85,86) and (87,88), since
  // Argentina's side meets Egypt's side, and Switzerland's side meets
  // Colombia's side (confirmed against the real R16 results).
